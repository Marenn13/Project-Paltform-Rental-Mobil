...
$durasi = isset($_GET['durasi']) ? $_GET['durasi'] : 'Tidak diketahui';
...
$totalPrice = (intval($price) * intval($durasi)) + $supirCost;
?>
...
<div class="container2">
    ...
    <h2> Detail Mobil</h2>
        <h4>Nama Mobil : <?php echo htmlspecialchars($carName); ?> / <?php echo htmlspecialchars($plate); ?></h4>
        ...
        <h4>Harga Sewa Mobil: IDR <?php echo number_format($price*$durasi, 0, ',', '.'); ?></h4>
    ...
    <h2> Detail Penyewa</h2>
        <h4>Nama  : <?php echo htmlspecialchars($name); ?></h4>
        <h4>Email: <?php echo htmlspecialchars($email); ?></h4>
        <h4>No HP : <?php echo htmlspecialchars($phone); ?></h4>
        <h4> Alamat: <?php echo htmlspecialchars($address); ?></h4>
            ...
            <input type="hidden" name="tgl_sewa" value="<?php echo htmlspecialchars($tglSewa); ?>">
            <input type="hidden" name="durasi" value="<?php echo htmlspecialchars($durasi); ?>">
            <input type="hidden" name="supir" value="<?php echo htmlspecialchars($supir); ?>">
            ...
            <div class="form-group">     
                <input type="submit" value="OK" a href="homepage.php" > </a>
            </div>
        </form>
    </div>
</div>
